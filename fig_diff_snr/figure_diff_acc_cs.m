...
for SNR= 15:5:20 %:0.05:0.2
    ...
    % %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%  DL Receiver: LISTA  %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
        ...
        [B_est_dl, H_est_dl] = DL(Y_pilot_rx_dl,SNR,num_colunm);
...
%%%%%%%%%%%%%%%%%%%%%% Dual-Net ( second iteration )%%%%%%%%%%%        
        ...
        [B_est_dnet, H_est_dnet] = DNET(Y_pilot_rx_dl,Y_data_rx_dl,SNR,num_colunm);
    ...
    %%%%%%%%%%%%%%%%%%%  AMP and ISTA Receiver %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
        ...
        [B_est_amp, H_est_amp,B_est_ista, H_est_ista] = ISTA(Y_pilot_rx_dl,cwplt_new,SNR);       
