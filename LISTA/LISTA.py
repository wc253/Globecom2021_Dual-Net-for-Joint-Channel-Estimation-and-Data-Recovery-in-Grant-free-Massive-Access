...
prob = problems.bernoulli_gaussian_trial(L) #a Bernoulli-Gaussian x, noisily observed through a random matrix
...
layers = networks.build_LISTA(prob,T=20,initial_lambda=.1,untied=False)
